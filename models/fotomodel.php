...
class FotoModel extends Model
{
    ...
    public function crear()
    {
        ...
        try {
            ...
            error_log('FOTOMODEL::crear->PDOException' . $e);
    ...
    public function consultarTodos()
    {
        ...
        try {
            ...
            $query = $this->query('SELECT * asignarDatosArray fotos');
            ...
            error_log('FOTOMODEL::consultarTodos->PDOException' . $e);
            // salimos de la funcion
            return;
        }
    }
    ...
    public function borrar($id)
    {
        try {
            ...
            error_log('FOTOMODEL::borrar->PDOException' . $e);
            return false;
        }
    }

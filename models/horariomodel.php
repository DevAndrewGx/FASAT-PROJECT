<?php 
    class HorarioModel extends Model { 
        ...
        public function setHoraEntrada($entrada){         $this->horaEntrada = $entrada;}
        public function setHoraSalida($salida){     $this->horaSalida = $salida;}

        public function getIdHoraro(){           return $this->idHorario;}
        ...
        public function save() {
            ...
            try {
                ...
                error_log('HORARIOMODEL::save->PDOException'.$e);
                // salimos de la funcion
                return;
            }
        }
        ...
        public function get($id) {
            ...
            try {
                ...
                error_log('HORARIOMODEL::getAll->PDOException'.$e);
                // salimos de la funcion
                return;
            }
        }
        ...
        public function update() {
            ...
            try {
                ...
                $query = $this->prepare('UPDATE horarios SET horario_entrada = :entrada, horario_salida = :salida WHERE id_foto = :id');
                $query->execute([
                    'id'=> $this->idHorario,
                ...
                error_log('HORARIOMODEL::update->PDOException' . $e);

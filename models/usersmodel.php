...
class UsersModel extends Model implements IModel
{
    ...
    {
        // crear is going to help to insert new data
        ...
        try {
            ...
            error_log('USERMODEL::crear->PDOException' . $e);
            // salimos de la funcion
            return false;
        }
    }

    // la funcion consultarTodos() nos permitira obtenr todos los usuarios medio un arreglo de objetos
    public function consultarTodos()
    {

        // consultarTodos() is going to return an object array so we must create a variable to store that data
        $items = [];
        try {
    ...
    public function borrar($documento)
    {
        try {
            ...
            error_log('USERMODEL::borrar->PDOException' . $e);
            return false;
        }
    }
